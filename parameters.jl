Base.@kwdef mutable struct Parameters
   prev::Float64 = 9.88438036368209
   rem::Float64 = 0.53
   rem_ther::Float64 =0.12022594017139093
   avail_high::Float64 = 0.8
   avail_middle::Float64 = 0.6
   avail_low::Float64 = 0.3
   rate_parents::Float64=  8.977369465051414
   rate_friends::Float64 = 7.492722013292066
   rate_friends_healthy::Float64 = 6.734712590959671
   rate_ac::Float64 = 4.972365907883779
   rate_child::Float64 = 2.8430125231863146
   rate_spouse::Float64 = 9.000579031752727
   rate_spouse_healthy::Float64 = 1.3350910709889188
   n::Int64 = 1000
   n_fam::Int64 = 280
   p_ac::Float64 = 15
   p_fr::Float64 = 4
   seed::Int64 = 0
   lambda::Float64 = 0.6963969562155559
   scaling::Float64 = 1.7896786737035928
   w_mean::Float64 = 0.7482487984003852
...
#Breite der Verteilung der susceptibility des Zufalls
  ...
  #Heritabilitätsindex(?)
   ...
   h_expo::Float64 = 0.18732091257364958
...
#durations beinhaltet die häufigsten Trennungsjahre, also wird zufällig eines dieser Jahre ausgewählt und dann aus einer Poisson-Verteilung die erwartete Beziehungsdauer bestimmt
 ...
 #Wahrscheinlichkeit wegen Depression Bildungsweg zu verlassen: hier noch nach korrekten Zahlen schauen
  ...
  #homophily
   homophily_friends::Float64 = 0.16047568811795718
   homophily_spouse::Float64 = 0.3496742660760617
   homophily_ac::Float64 = 0.895567098006724
